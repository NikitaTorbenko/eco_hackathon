        ...
        {data.length !== 0 ? (
          <div>
            ...
            <div className={style.info}>
              <span>
                <FaUser /> Автор: {data[0].username || "неизвестно"}
              </span>
              <span>
                <FaTrashRestore />
                ...
                <div
                  style={{
                    backgroundColor:
                      trashLevels[data[0].pullutionLevel || 0].color,
                  }}
                ...
                <span
                  ...
                  style={{
                    color: trashLevels[data[0].pullutionLevel || 0].color,
                  }}
                >
              ...
              <span>
                <FaCalendarAlt /> дата: {data[0].date || "неизвестно"}
              </span>
            </div>
            <div className={style.description}>{data[0].message}</div>
          </div>
        ) : (
          <Text margin="20px">Данных нет, добавьте свой первый репорт</Text>
        )}
